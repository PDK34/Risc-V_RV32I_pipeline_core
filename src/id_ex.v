module id_ex (
    ...
    always@(posedge clk)begin
        if(rst)begin
            ...
            RdE<=5'b0; Rs2E<=5'b0; Rs1E<=5'b0;  ALUControlE<=4'b0;
            ALUSrcE<=1'b0; JumpE <= 1'b0; BranchE<=1'b0; RegWriteE<=1'b0; MemWriteE<=1'b0; 
            ResultSrcE<=2'b0; funct3E <= 3'b0;   jalrE<=1'b0; isLuiE <= 1'b0;
        end
        else if(flush)begin
            ReadData1E <= 32'b0; ReadData2E <= 32'b0;
            PCE<=32'b0; PCPlus4E<=32'b0; immExtendedE<=32'b0;
            ...
            ResultSrcE<=ResultSrcD; funct3E <= funct3D;   jalrE<=jalrD;  isLuiE <=isLuiD;
        end
    end
